  ...
  return (
    ...
    >
      ...
      <div className=" !h-[calc(100vh-64px-74px);] flex justify-center items-center">
        <div className="bg-gray-800 rounded shadow-lg p-4 px-4 md:p-8 mb-6 container mx-auto flex gap-20 justify-around items-center">
             <div className="text-gray-200 flex justify-center items-center ">
              <div>
              <p className="font-bold tracking-wide text-center  text-3xl uppercase ">
                User Details{" "}
              </p>
